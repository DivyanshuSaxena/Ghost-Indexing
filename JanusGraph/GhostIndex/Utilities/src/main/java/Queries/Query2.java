...
public class Query2 extends Query{
    ...
    public QueryResult runQuery(List<String> params) throws ParseException {
        ...
        /*
        * FIXME: Checking running and correctness of query2 - not yet complete. grouping left
         * */
//        Vertex c1 = g.V().has("pl_id", P.gte(0)).has("name", textContains(country1)).next();
//        Vertex c2 = g.V().has("pl_id", P.gte(0)).has("name", textContains(country2)).next();
