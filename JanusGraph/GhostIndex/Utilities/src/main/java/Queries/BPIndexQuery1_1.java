...
import main.BPlusIndexRangeQueryRepeat;
...
public class BPIndexQuery1_1 extends Query{
    private static final Logger LOGGER = LoggerFactory.getLogger(BPIndexQuery1_1.class);

    public static void main(String[] args) throws Exception {
        BPIndexQuery1_1 query = new BPIndexQuery1_1();
...
//            date = 1262651400000L;
        ...
        String indexName = "post_creationDate_index_bPlus_1000";
        ...
        BPlusIndexRangeQueryRepeat irq = new BPlusIndexRangeQueryRepeat(g, indexName);
...
//            vertexIds.add((Long) vertices.get(i).id());
//        }
...
//
        ...
        if(vertices.size() > 0) {
            result = g.V(vertices)//.hasLabel("post")
                ...
                }).by(__.group().by(T.label).by(__.group().by(it -> {
