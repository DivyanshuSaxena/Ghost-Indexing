...
# $5 : Fullpath to the neo4j/ installation directory
...
# $8 : Cache size under which Neo4J is running
# $9 : Username for the cypher shell
# $10 : Password for the cypher shell
